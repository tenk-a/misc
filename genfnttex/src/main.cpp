...
private:
    ...
    void copyFont(uint8_t* tex, unsigned nx, unsigned ny, uint8_t const* font) {
        for (unsigned y = 0; y < fontW_; ++y) {
            for (unsigned x = 0; x < fontW_; ++x) {
                int xx = nx * cellW_ + x;
                int yy = ny * cellW_ + y;
                tex[yy * texW_ + xx] = font[y * fontW_ + x];
            }
        }
    }
    ...
    bool saveCTableHeader() {
        ...
        fprintf(fp, "\n");
        fprintf(fp, "typedef struct ChFontTableFont1 {\n");
        ...
        fprintf(fp, "\n");
        fprintf(fp, "extern ChFontTableInfo\tg_chFontTableInfo;\n");
        fprintf(fp, "extern ChFontTable\tg_chFontTable[];\n");
        fprintf(fp, "\n");
        fprintf(fp, "#ifdef __cplusplus\n");
        fprintf(fp, "} //extern \"C\"\n");
        fprintf(fp, "#endif\n");
    ...
    bool saveCTable() {
        ...
        fprintf(fp, "\n");
        fprintf(fp, "ChFontTableInfo\tg_chFontTableInfo = {\n");
        ...
        fprintf(fp, "\n");
        fprintf(fp, "\n");
        fprintf(fp, "ChFontTable\tg_chFontTable[] = {\n");
        char buf[2048] = {0};
