...
void usage(void)
{
	cout<< "c2htm [-opts] file(s)    // v1.72  " __DATE__  "  writen by M.Kitamura\n"
		   " c/c++ソースを色つきhtmlに変換(html4.0)\n"
...
public:
	Opts(const char *appNm="")
		: outName_(""), lnoSep_(""), tabSz_(-1), lnoClm_(-1), useUtf8_(-1)
		, stdio_(0), cfgOut_(0), hdrFtrMd_(0), markStr_(""), markMd_(0)
	{
...
class Conv {
public:
	Conv() : css_(""), cfgName_(""), hdrFtrMd_(0), lnoClm_(0)
		, lnoSep_(""), tabSz_(0), symChrs_(""), nameSyms_("")
	{
