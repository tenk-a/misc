...
void rename_e(char *oldname, char *newname)
{
...
void chkzenyen(FILE *fp, char *fnam)
{
	unsigned long cnt;
	UCHAR *p;
...
void findZen(FILE *fp, char *fnam)
{
	unsigned long cnt;
	UCHAR *p;
...
void one(FILE *fp, FILE *ofp, unsigned opt, unsigned opt2, char *fnam)
{
	int  k;
	unsigned long cnt;
...
int main(int argc, char *argv[])
{
	...
	FILE *fp,*ofp;
	char *oname;
	unsigned i,mode,mode2,chk2yen,chk2kan;
	char *p;
	int	 c,n;
