...
instruction instTable[] =
{
	...
	{"TTL",  NULL,   0,                   FALSE,NoProblem},	/* */
	{"UNLK", unlkfl, flavorCount(unlkfl), TRUE, NULL},
	{"XDEF", NULL,   0,                   FALSE,NoInpl/*xdef*/}, 	/* */
	{"XREF", NULL,   0,                   FALSE,NoInpl},	/* */
};
