...
int     move(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
...
int     zeroOp(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
...
int     oneOp(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
...
int     arithReg(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
...
int     arithAddr(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
...
int     immedInst(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	unsigned short type;

	/* Check whether the instruction is an immediate ADD or SUB that can be assembled as ADDQ or SUBQ */
...
int     quickMath(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	int     status;
...
int     movep(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
		if (source->mode == DnDirect) {
		/* Convert plain address register indirect to address register indirect with displacement of 0 */
			if (dest->mode == AnInd) {
				dest->mode = AnIndDisp;
				dest->data = 0;
			}
...
int     moves(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
...
int     moveReg(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
		output((long) (mask | effAddr(dest)), WORD);
	loc += 2;
...
int     staticBit(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		output((long) (mask | effAddr(dest)), WORD);
		loc += 2;
...
int     movec(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
...
int     trap(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
...
int     branch(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	char    shortDisp;
	long    disp;
...
int     moveq(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
...
int     immedToCCR(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		output((long) (mask), WORD);
		loc += 2;
...
int     immedWord(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		output((long) (mask), WORD);
		loc += 2;
		...
		loc += 2;
		if (source->data < -32768L || source->data > 65535L)
...
int     dbcc(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	short   disp;

	disp = (short) (dest->data - loc - 2);
	if (pass2) {
		output((long) (mask | source->reg), WORD);
		loc += 2;
		output((long) (disp), WORD);
		loc += 2;
		if ((long)disp < -32768L || (long)disp > 32767L)
			NEWERROR(*errorPtr, INV_BRANCH_DISP);
	} else
		loc += 4;
...
int     scc(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2)
		output((long) (mask | effAddr(source)), WORD);
	loc += 2;
...
int     shiftReg(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		mask |= dest->reg;
...
int     exg(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
...
int     twoReg(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		output((long) (mask | (dest->reg << 9) | source->reg), WORD);
	}
...
int     oneReg(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		output((long) (mask | source->reg), WORD);
	}
...
int     moveUSP(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		if (source->mode == AnDirect)
			output((long) (mask | source->reg), WORD);
...
int     link(int mask,int size,opDescriptor *source,opDescriptor *dest,int *errorPtr)
{
	if (pass2) {
		output((long) (mask | source->reg), WORD);
		loc += 2;
		...
		loc += 2;
		if (dest->data < -32768L || dest->data > 32767L)
			NEWERROR(*errorPtr, INV_16_BIT_DATA);
	} else {
		loc += 4;
	}
